  ...
  try {
    ...
    try {
      ...
      await writeAdminAuditLog(db, {
        ...
        entityType: "booking",
        entityId: bookingId,
        message: "Resend documents requested (scaffold action)",
        meta: {
    ...
    return NextResponse.json({
      ok: true,
      message: "Resend documents request recorded. Document regeneration is not enabled in this phase.",
    });
  } catch {
    return routeError(500, "Failed to record resend documents action");
  }
}
