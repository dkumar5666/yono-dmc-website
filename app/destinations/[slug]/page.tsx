  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-14">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {filtered.map((pkg) => (
          <article key={pkg.slug} className="border rounded-xl bg-white shadow-sm overflow-hidden">
            <div className="flex flex-col sm:flex-row">
              ...
              <Link
                ...
                className="inline-flex items-center bg-[#f5991c] text-white px-4 py-2 rounded-lg font-medium"
              >
                View Full Package
              </Link>
              </div>
